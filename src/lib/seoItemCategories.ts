...
export const upperLimbExercisesCategory: SeoItemCategoryConfig = {
    ...
    metaDescription:
        "上肢・肩・肘・手首・手指の自主トレに使える無料イラスト。肩挙上、振り子運動、タオルや棒を使った運動、箸やペグの巧緻動作までそろっています。脳卒中の片麻痺、肩関節周囲炎、術後の可動域訓練に。PT・OTの患者指導や退院前指導、配布資料にそのままお使いいただけます。",
    intro:
...
export const lowerLimbExercisesCategory: SeoItemCategoryConfig = {
    ...
    metaDescription:
        "下肢・股関節・膝・足関節の自主トレに使える無料イラスト。クアドセット、自動SLR、ヒールスライド、スクワット、ブリッジ、かかと上げなど。変形性膝関節症、人工関節の術後、廃用予防に。PTの患者指導、介護予防教室、患者配布資料に無料でお使いいただけます。",
    intro:
...
export const trunkExercisesCategory: SeoItemCategoryConfig = {
    ...
    metaDescription:
        "体幹・腹筋・背筋・骨盤の自主トレに使える無料イラスト。ドローイン、骨盤の前後傾、膝をついてプランク、ダイアゴナル、キャットアンドドッグ、四つん這いの運動まで。慢性腰痛、姿勢の崩れ、体幹機能の低下に。リハビリ指導や患者配布資料へ登録不要でお使いいただけます。",
    intro:
...
export const stretchingExercisesCategory: SeoItemCategoryConfig = {
    ...
    metaDescription:
        "上肢・下肢・体幹のストレッチに使える無料イラスト。ハムストリングス、アキレス腱、胸開き、ドアウェイストレッチなど部位別に探せます。保持時間の目安も入っています。柔軟性の低下、運動前の準備運動、運動後の整理運動に。患者配布資料へ無料でお使いいただけます。",
    intro:
...
export const walkingExercisesCategory: SeoItemCategoryConfig = {
    ...
    metaDescription:
        "歩行訓練に使える無料イラスト。杖歩行、固定型歩行器、平行棒内歩行、ノルディック歩行、階段昇降、段差のステップまで。杖の持ち方や足を出す順番の指導にも使えます。脳卒中や骨折術後の歩行練習、退院前指導、家族への説明資料に無料でお使いいただけます。",
    intro:
...
export const seatedExercisesCategory: SeoItemCategoryConfig = {
    ...
    metaDescription:
        "高齢者が椅子に座ってできる座位体操の無料イラスト。足踏み、かかと上げ、体側倒し、肩回し、腹式呼吸まで。座ったままできる口腔体操もあります。立位が不安定な方にもそのまま渡せます。通所リハ、デイサービス、介護予防教室、患者配布資料に登録不要でお使いいただけます。",
    intro:
...
export const handRehabilitationCategory: SeoItemCategoryConfig = {
    ...
    metaDescription:
        "手指リハビリ・巧緻動作訓練の無料イラスト。グーとパー、タオル握り、洗濯ばさみ、ペグ操作、硬貨、箸操作までそろっています。難易度に幅があるので、渡す相手に合わせて選べます。脳卒中後の手指麻痺、関節リウマチ、握力の低下に。OTの患者配布資料にお使いいただけます。",
    intro:
...
export const fallPreventionCategory: SeoItemCategoryConfig = {
    ...
    metaDescription:
        "高齢者の転倒予防体操・バランス訓練の無料イラスト。片足立ち、サイドステップ、段差のステップ、かかと上げ、つま先上げなど。手すりや支持物を使う形もそろえています。つまずきやすい方、下肢筋力が低下した方に。デイサービスや介護予防教室の資料に無料でお使いいただけます。",
    intro:
...
export const bedMobilityCategory: SeoItemCategoryConfig = {
    ...
    metaDescription:
        "寝返りから起き上がり、端座位までのベッド上動作の無料イラスト。仰向けから横向き、側臥位での肘立て、端座位の保持、ベッドからの立ち上がりまで。クッションを使った横向き寝のポジショニングもあります。脳卒中の片麻痺、術後の離床、ご家族への説明資料に無料でお使いいただけます。",
    intro:
...
export const strokeExercisesCategory: SeoItemCategoryConfig = {
    ...
    metaDescription:
        "脳卒中・片麻痺の自主トレに使える無料イラスト。上肢の自己介助運動、手指の巧緻動作、寝返りや起き上がり、更衣動作まで。麻痺側のポジショニングや、患側から着る更衣の手順もあります。PT・OT・STの患者指導、退院前指導、家族への説明に無料でお使いいただけます。",
    intro:
