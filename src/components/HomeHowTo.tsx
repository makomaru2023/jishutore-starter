...
const steps: Step[] = [
    {
        number: "01",
        title: "部位・目的から\n探す",
        description: "カテゴリやキーワードで検索。200点以上のイラストから1枚がすぐ見つかります。",
    ...
    },
    {
        number: "02",
        title: "ワンクリックで\nダウンロード",
        description: "会員登録もメアド入力も不要。クリック1つでPNG画像をダウンロードできます。",
    ...
    },
    {
        number: "03",
        title: "資料に貼って\n患者さんへ",
        description: "PowerPointやWordにそのまま貼って印刷。指導書としてもお使いいただけます。",
