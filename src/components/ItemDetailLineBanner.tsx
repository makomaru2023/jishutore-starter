...
export function ItemDetailLineBanner() {
    return (
        <div className="rounded-2xl px-5 py-4" style={{ backgroundColor: "#06C755" }}>
            <div className="flex flex-col gap-3 text-center sm:flex-row sm:items-center sm:justify-between sm:text-left">
                ...
                <a
                    ...
                    onClick={() => trackLineClick("item_detail_banner")}
                    className="inline-flex flex-shrink-0 items-center justify-center gap-2 rounded-full bg-white px-5 py-2.5 text-sm font-black shadow-sm transition-all hover:scale-105"
                    style={{ color: "#06C755" }}
                >
