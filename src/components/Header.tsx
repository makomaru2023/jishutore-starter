                ...
                <nav className="hidden md:flex items-center gap-8">
                    ...
                    {isPlusProductPage ? (
                        <Link
                            ...
                            className="ml-2 flex items-center rounded-full bg-blue-600 px-6 py-2 text-sm font-bold text-white transition-all hover:bg-blue-500 hover:shadow-lg hover:shadow-blue-500/30"
                        >
