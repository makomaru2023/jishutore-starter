...
export const metadata: Metadata = {
    ...
    description:
        // ★2026-08-17：Bing の「description が短すぎる」警告を受けて104字→153字へ拡充。
        "訪問リハ・通所リハ・通所介護・老健・訪問看護からのリハ・回復期リハ病棟・地域包括ケア病棟・急性期一般病棟の8分野148項目。加算と減算の算定要件、単位数・点数、告示や通知など根拠資料へのリンクを無料公開しています。毎月の改定確認で内容を更新。記録に残すことと自己点検のポイントは自主トレ素材庫Plusで確認できます。",
    alternates: {
