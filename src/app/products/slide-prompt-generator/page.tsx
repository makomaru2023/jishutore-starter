...
export const metadata: Metadata = {
    title: "伝わるプロンプト工房｜ChatGPTでスライド画像を量産する会員専用ツール｜自主トレ素材庫",
    description:
        "用途・テーマ・枚数を選ぶだけで、ChatGPT にそのまま貼り付けられるスライド画像生成プロンプトを作成できる会員専用ツール。現在は自主トレ素材庫Plusに収録されています。家族説明・勉強会・利用者説明・退院前指導の資料づくりを時短。",
    openGraph: {
        title: "伝わるプロンプト工房｜自主トレ素材庫",
        description:
            "ChatGPT に貼り付けるだけで、リハビリ・介護現場向けのスライド画像プロンプトが完成。自主トレ素材庫Plusに収録。",
    },
};
                    ...
                    <div className="container mx-auto px-4">
                        <div className="mx-auto max-w-3xl text-center">
                            ...
                            <div className="mt-8 flex flex-col items-center justify-center gap-3">
                                ...
                                <Link
                                    href="#how-to-use"
                                    className="inline-flex w-full max-w-md items-center justify-center gap-2 rounded-full border border-slate-200 bg-white px-7 py-3 text-base font-bold text-slate-700 transition-colors hover:border-blue-200 hover:text-blue-700"
                                >
                                    使い方を見る
                                </Link>
                            </div>
                                    ...
                                    <thead className="border-b border-slate-200 bg-slate-50">
                                        <tr>
                                            ...
                                            <th className="p-4 text-center text-sm font-black text-blue-700 break-keep">
                                                フル版<span className="block text-[11px] font-bold text-blue-500">Plus会員</span>
                                            </th>
                                        </tr>
                                    </thead>
                                    <tbody>
                    ...
                    <div className="container mx-auto px-4">
                        <div className="mx-auto max-w-2xl">
                            <div className="rounded-3xl border border-blue-100 bg-gradient-to-b from-blue-50/60 to-white p-7 sm:p-10 text-center">
                                ...
                                <p className="text-sm leading-relaxed text-slate-600 mb-6 break-keep">
                                    個別販売は終了しました。Plus会員は追加料金なしで、会員ページからそのままご利用いただけます。
                                </p>
                                <PlusMergedCta />
                            </div>
                        </div>
