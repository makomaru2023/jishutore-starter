...
const RECOMMENDED = [
    ...
    "訪問リハで患者さんに渡せる資料が欲しい",
    "口頭説明だけでは自主トレが定着しにくいと感じている",
    "家族にも運動内容を共有したい",
    "自施設用に編集できるPowerPoint資料が欲しい",
    "無料イラストを貼る時間すら惜しい",
];
...
const FAQS: { q: string; a: string }[] = [
    {
        ...
        a: "決済完了後に表示されるサンクスページからダウンロードしていただけます。万一ダウンロードできない場合は、購入時のメールアドレスを添えてお問い合わせください。",
    },
    {
        q: "PowerPointがないと使えませんか？",
        a: "PowerPointでの編集を想定しています。環境によってはGoogleスライドやKeynoteで開ける場合もありますが、表示崩れが起こる可能性がある点はご了承ください。",
    },
    {
        q: "内容を編集してもいいですか？",
...
function SectionHeading({ kicker, title }: { kicker?: string; title: string }) {
    return (
        <div className="mb-8 sm:mb-10 text-center">
            ...
            <h2 className="text-2xl sm:text-3xl font-black leading-snug text-slate-900 break-words">
                {title}
            </h2>
        </div>
    );
            ...
            <main className="flex-1">
                ...
                <section className="relative bg-gradient-to-b from-blue-50 via-white to-white pt-12 pb-16 sm:pt-16 sm:pb-20">
                    <div className="mx-auto w-full max-w-5xl px-4 sm:px-6 lg:px-8">
                        <div className="mx-auto max-w-3xl text-center space-y-6">
                            ...
                            <h1 className="text-2xl sm:text-4xl font-black leading-snug tracking-tight text-slate-900 break-words">
                                退院前・訪問リハの自主トレ説明、
                                <br className="hidden sm:block" />
                                毎回ゼロから作っていませんか？
                            </h1>
                            <p className="mx-auto max-w-2xl text-sm sm:text-base font-medium leading-relaxed text-slate-600">
                                疾患別に使えるPowerPoint資料9本を、印刷・編集できる形でまとめました。
                                患者さんやご家族が、自宅で見返しやすい自主トレ説明資料として使えます。
                            </p>
                            ...
                            <div className="flex flex-wrap justify-center gap-2 pt-2">
                                {HERO_BADGES.map((badge) => (
                                    <span
                                        key={badge}
                                        className="inline-flex items-center gap-1.5 rounded-full border border-blue-100 bg-white px-3 py-1.5 text-xs sm:text-sm font-bold text-blue-700 shadow-sm"
                                    >
                    ...
                    <div className="mx-auto w-full max-w-5xl px-4 sm:px-6 lg:px-8">
                        ...
                        <ul className="mx-auto grid max-w-3xl grid-cols-1 gap-3 sm:grid-cols-2 sm:gap-4">
                            {PAIN_POINTS.map((point) => (
                                <li
                                    key={point}
                                    className="flex items-start gap-3 rounded-2xl border border-slate-200 bg-white px-5 py-4 text-sm leading-relaxed text-slate-700 shadow-sm break-words"
                                >
                ...
                <section className="bg-white py-14 sm:py-20">
                    <div className="mx-auto w-full max-w-3xl px-4 sm:px-6 lg:px-8 text-center">
                        ...
                        <p className="mt-6 text-sm sm:text-base leading-relaxed text-slate-600">
                            無料素材は、自分で資料を作りたい方向けのイラスト素材です。
                            一方、このPowerPoint資料セットは、説明の流れ・運動メニュー・注意点までまとめた完成資料です。
                            必要な部分だけ編集して、退院前指導・訪問リハ・家族説明に使えます。
                        </p>
                    </div>
                </section>
                                    ...
                                    <tbody>
                                        {COMPARISON_ROWS.map((row) => (
                                            <tr key={row.label} className="border-t border-slate-100 align-top">
                                                ...
                                                <td className="px-5 py-4 text-slate-600 break-words">{row.free}</td>
                                                <td className="px-5 py-4 font-bold text-slate-800 bg-blue-50/40 break-words">
                                                    {row.paid}
                                                </td>
                                            </tr>
                                        ))}
                ...
                <section id="contents" className="bg-white py-14 sm:py-20 scroll-mt-24">
                    <div className="mx-auto w-full max-w-6xl px-4 sm:px-6 lg:px-8">
                        ...
                        <div className="mx-auto mb-8 max-w-2xl rounded-2xl border border-blue-100 bg-blue-50/60 px-5 py-4 text-center">
                            <p className="text-sm sm:text-base font-bold text-blue-800 leading-relaxed break-words">
                                9枚のスライドではありません。
                                <br className="sm:hidden" />
                                <span className="text-blue-600">9本のPowerPoint資料セット</span>です。
                            </p>
                            <p className="mt-2 text-xs sm:text-sm text-slate-600 leading-relaxed">
                                1本の資料の中に、表紙・説明・運動メニュー・手順・回数の目安・注意点・継続のコツまで入っています。
                            </p>
                        </div>
                            ...
                            {CONTENTS.map((item, idx) => (
                                ...
                                >
                                    <div className="mb-3 flex items-center gap-3">
                                        ...
                                        <h3 className="text-base font-black text-slate-900 break-words">
                                            {item.title}
                                        </h3>
                                    </div>
                        ...
                        <ol className="mx-auto grid max-w-4xl grid-cols-1 gap-4 sm:grid-cols-3">
                            {USE_STEPS.map((step, idx) => (
                                ...
                                >
                                    ...
                                    <p className="pt-2 text-sm sm:text-base font-bold text-slate-800 leading-relaxed break-words">
                                        {step}
                                    </p>
                                </li>
                            ))}
                        ...
                        <div className="mt-10">
                            ...
                            <div className="flex flex-wrap justify-center gap-2">
                                {USE_SCENES.map((scene) => (
                                    <span
                                        key={scene}
                                        className="rounded-full border border-blue-200 bg-white px-4 py-1.5 text-xs sm:text-sm font-bold text-blue-700 shadow-sm"
                                    >
                                        {scene}
                                    </span>
                                ))}
                    ...
                    <div className="mx-auto w-full max-w-3xl px-4 sm:px-6 lg:px-8">
                        <div className="rounded-2xl border border-amber-200 bg-amber-50 px-5 py-6 sm:px-7 sm:py-8">
                            <div className="mb-3 flex items-center gap-2">
                                ...
                                <h2 className="text-lg sm:text-xl font-black text-amber-900 break-words">
                                    購入前にご確認ください
                                </h2>
                            </div>
                            <p className="text-sm sm:text-base leading-relaxed text-amber-900 break-words">
                                この資料は、すべての患者さんにそのまま使える医療プロトコルではありません。
                                対象者の状態、医師の指示、疼痛、禁忌、術後時期に合わせて、専門職の判断で編集してご使用ください。
                            </p>
                        </div>
                    </div>
                </section>
                        ...
                        <div className="rounded-3xl border-2 border-blue-200 bg-gradient-to-br from-blue-50/60 to-white px-6 py-8 sm:px-10 sm:py-10 shadow-sm">
                            ...
                            <ul className="mx-auto mt-6 grid max-w-md grid-cols-1 gap-2 sm:grid-cols-2">
                                {["PowerPoint形式", "編集OK", "印刷配布OK", "買い切り（追加料金なし）"].map((item) => (
                                    <li
                                        key={item}
                                        className="flex items-center gap-2 rounded-xl bg-white border border-slate-200 px-3 py-2 text-xs sm:text-sm font-bold text-slate-700"
                                    >
                        ...
                        <div className="space-y-3">
                            {FAQS.map((faq, idx) => (
                                <details
                                    ...
                                    open={idx === 0}
                                >
                                    <summary className="flex cursor-pointer list-none items-start justify-between gap-3 text-sm sm:text-base font-bold text-slate-900 break-words">
                ...
                <section className="bg-slate-50 py-14 sm:py-20">
                    <div className="mx-auto w-full max-w-4xl px-4 sm:px-6 lg:px-8">
                        <div className="text-center mb-6 sm:mb-8">
                            ...
                            <p className="mt-4 mx-auto max-w-2xl text-sm sm:text-base leading-relaxed text-slate-600 break-words">
                                腰痛版の一部サンプルや、自主トレ継続に役立つ補助シートを無料配布しています。
                                <br className="hidden sm:block" />
                                有料版では、9テーマすべてのPowerPoint資料を編集可能な形でご利用いただけます。
                            </p>
                        </div>
                        <LineBanner />
                    </div>
                ...
                <section className="bg-gradient-to-b from-white to-blue-50/60 py-16 sm:py-24">
                    <div className="mx-auto w-full max-w-3xl px-4 sm:px-6 lg:px-8 text-center">
                        ...
                        <p className="mt-6 text-sm sm:text-base leading-relaxed text-slate-600 break-words">
                            対象疾患の資料を開き、必要な部分を調整して印刷するだけ。
                            患者さんとご家族に、自宅で見返せる自主トレ資料を渡せます。
                        </p>
