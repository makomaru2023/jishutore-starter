...
import { walkingExercisesCategory as config } from "@/lib/seoItemCategories";

/**
 * /items/walking-exercises/page/<N>/ … 2ページ目以降。
 * ★1ページ目は /items/walking-exercises/（このルートは2以上だけを受ける）。
