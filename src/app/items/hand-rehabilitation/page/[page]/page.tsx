...
import { handRehabilitationCategory as config } from "@/lib/seoItemCategories";

/**
 * /items/hand-rehabilitation/page/<N>/ … 2ページ目以降。
 * ★1ページ目は /items/hand-rehabilitation/（このルートは2以上だけを受ける）。
