...
import { fallPreventionCategory as config } from "@/lib/seoItemCategories";

/**
 * /items/fall-prevention-exercises/page/<N>/ … 2ページ目以降。
 * ★1ページ目は /items/fall-prevention-exercises/（このルートは2以上だけを受ける）。
