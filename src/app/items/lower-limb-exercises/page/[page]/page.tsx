...
import { lowerLimbExercisesCategory as config } from "@/lib/seoItemCategories";

/**
 * /items/lower-limb-exercises/page/<N>/ … 2ページ目以降。
 * ★1ページ目は /items/lower-limb-exercises/（このルートは2以上だけを受ける）。
