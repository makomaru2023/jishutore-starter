...
import { upperLimbExercisesCategory as config } from "@/lib/seoItemCategories";

/**
 * /items/upper-limb-exercises/page/<N>/ … 2ページ目以降。
 * ★1ページ目は /items/upper-limb-exercises/（このルートは2以上だけを受ける）。
