...
import { stretchingExercisesCategory as config } from "@/lib/seoItemCategories";

/**
 * /items/stretching-exercises/page/<N>/ … 2ページ目以降。
 * ★1ページ目は /items/stretching-exercises/（このルートは2以上だけを受ける）。
