...
export const metadata: Metadata = {
    title: INDEX_TITLE,
    description:
        // ★2026-08-17：Bing の「description が短すぎる」警告を受けて93字→146字へ拡充。
        "リハビリ専門職向けのコラムです。加算の算定の流れと記録の残し方、毎月の報酬改定・疑義解釈ウォッチ、告示や通知の読み方、自主トレ資料の作り方を、作業療法士が一次資料を確認しながら書いています。図解つきで、報酬チェックの各項目からも読めます。訪問リハ・通所リハ・老健・回復期リハ病棟が中心です。",
    alternates: {
        canonical: PAGE_URL,
    },
    openGraph: {
